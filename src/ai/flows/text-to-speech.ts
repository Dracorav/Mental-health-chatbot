 ...
 *
 * - textToSpeech - A function that converts text to speech and returns a data URI.
 * - TextToSpeechInput - The input type for the textToSpeech function (a string).
 * - TextToSpeechOutput - The return type for the textToSpeech function (an object containing the audio data URI).
 */
